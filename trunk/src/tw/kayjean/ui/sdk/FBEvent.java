...
public class FBEvent {
	...
	public native void subscribe(String event, Callback<JavaScriptObject> callback ) /*-{
		...
		$wnd.FB.Event.subscribe(event,function(response){
			app.@tw.kayjean.ui.sdk.FBEvent::callbackSuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/google/gwt/core/client/JavaScriptObject;)(callback,response);
		});
	}-*/;
