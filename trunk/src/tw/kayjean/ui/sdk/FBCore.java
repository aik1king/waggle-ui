...
public class FBCore {
	...
	public native void api ( String path, AsyncCallback<JavaScriptObject> callback ) /*-{
		...
		$wnd.FB.api (path, function(response){
	        app.@tw.kayjean.ui.sdk.FBCore::callbackSuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/google/gwt/core/client/JavaScriptObject;)(callback,response);
		});
	}-*/;
