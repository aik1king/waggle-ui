...
System.out.println( name );
	...
	{
		//先從http://ip-to-country.webhosting.info/這裡下載成為ip-to-country.csv
		//直接用 -c ip-to-country.csv 可以把 KayjeanKu\workspace\waggle-ui 目錄下面ip-to-country.csv 變成ip-to-country.bin
		//再使用-r 85.64.225.159 結果就是IL ISR ISRAEL, 讀取的資料就是KayjeanKu\workspace\waggle-ui 目錄下面 ip-to-country.bin
		//兩者檔案位置都是一樣想法
		
		//資料來源,可以參考這裡,非常詳細
		//http://ipinfodb.com/ip%5Fdatabase.php
		//表現位置在http://ipinfodb.com/index.php
		//效果已經非常好了
